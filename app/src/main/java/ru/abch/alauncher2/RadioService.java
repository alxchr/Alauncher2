...
public class RadioService extends Service {
    ...
    public void onCreate() {
        ...
        ctx = this;
        try {
            serialPort = App.get().getMcuSerialPort();
            serialPort.openPort();
            ...
            readThread.start();
            Log.d(TAG, "MCU serial port " + serialPort.getSystemPortPath());
        } catch (Exception e) {
        ...
        if(radioState == null) radioState = new RadioState(((App) getApplication()).getChannel(),
                ((App) getApplication()).getVolume());
    }
    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            int freq = intent.getIntExtra("freq", ((App) getApplication()).getChannel());
            int volume = intent.getIntExtra("vol", ((App) getApplication()).getVolume());
                    ...
                    if (readBufferPos > 0) {
                        ...
                        try {
                            ...
                            if (radioState != null) {
                                ...
                                radioStateParcel.voltage = radioState.voltage;
                                Intent intent = new Intent("ru.abch.alauncher2.state", null);
                        ...
                        try {
                            ...
                            if (freqs != null) {
                                ...
                                ((App) getApplication()).saveFreqsList(freqsList);
                                Intent intent = new Intent("ru.abch.alauncher2.freqs", null);
